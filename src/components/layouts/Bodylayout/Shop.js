    ...
    <section className="firstSection">
      <div className="shopSection">
        <div className="shopImageDiv imageheadphones">
          <img
            className="desktop"
            src={
              require("../../../assets/shared/desktop/imageheadphones.png")
                .default
            }
            alt="imageheadphones"
          ></img>
      ...
      <div className="shopSection">
        <div className="shopImageDiv imagespeakers">
          <img
            src={
              require("../../../assets/shared/desktop/imagespeakers.png")
                .default
            }
            alt="imagespeakers"
          ></img>
      ...
      <div className="shopSection">
        <div className="shopImageDiv  imageearphones">
          <img
            src={
              require("../../../assets/shared/desktop/imageearphones.png")
                .default
            }
            alt="imageearphones"
          ></img>
