...
function Success(props) {
  ...
  const { removeAllandReturn, successDisplay, summaryItems } = AudioContext;

  //FETCH GRAND TOTAL FROM LOCAL STORAGE
  ...
  return (
    <div className="SuccessMain" style={successDisplay}>
          ...
          <div className="qtyImg">
            <div className="imgPrice">
              <div className="successImg">
                <img
                  src={
                    require("../../assets" + summaryItems[0].image.desktop)
                      .default
                  }
                  alt="simmarydesktop"
                ></img>
      ...
      <Link onClick={removeAllandReturn} className="successLink" to="/">
